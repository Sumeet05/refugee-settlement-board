...
export class TableDataSource extends DataSource<TableItem> {
  ...
  constructor(tableData: TableItem[]) {
    super();
    this.data = tableData;
  }
  ...
  private getSortedData(data: TableItem[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        case 'familySize': return compare(+a.familySize, +b.familySize, isAsc);
        case 'dateOfArrival': return compare(a.dateOfArrival, b.dateOfArrival, isAsc);
